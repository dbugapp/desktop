...
package() {
  ...
  install -Dm644 $ASSETS_DIR/org.fumeapp.dbug.appdata.xml -t $ARCHIVE_DIR/share/metainfo
  install -Dm644 $ASSETS_DIR/org.fumeapp.dbug.desktop -t $ARCHIVE_DIR/share/applications
